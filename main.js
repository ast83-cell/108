...
function startClassification(){
    ...
    classifier = ml5.soundClassifier('https://teachablemachine.withgoogle.com/models/q0Tp5IaaC/model.json', modelready);
...
function gotresults(error, results){
    ...
    if (error){
        ...
        document.getElementById("detected").innerHTML = "detected dog - "+dog+", detected cat - "+cat+", detected sheep - "+sheep+", detected lion - "+lion;
        ...
        document.getElementById("voice").style.color = "rgb("+random_r+","+random_g+","+random_b+")";
        document.getElementById("voice").style.fontFamily = 'noto'+","+'sans'+","+'jp';
